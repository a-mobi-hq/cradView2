...
function QuestionBusIntro() {
 ...
 const questionSubType ="PointsOfDifferentiation";
 ...
 const [showScrollableDiv, setShowScrollableDiv] = useState(false);
    ...
    const onClickNext = () => navigate(`/questionVppPp`);
 ...
 useEffect(() => {
   const fetchAnswers = async () => {
     ...
     if(summaryResponse.ok) {
       ...
       const response = await fetch(API_BASE_URL + `/api/new/question/ValuePropositionPack/PointsOfDifferentiation/${projectId}`);
       if (!response.ok) {
   ...
   if (isResizing) {
    ...
    <div className='container2'>
         ...
         <div className='text-center'>
                    <p className='textHp'>Points of Differentiation</p>

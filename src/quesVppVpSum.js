...
function QuestionBusIntro() {
 ...
 const questionSubType ="ValueDeliveryProcess";
 ...
 useEffect(() => {
   const fetchAnswers = async () => {
     ...
     if(summaryResponse.ok) {
       ...
       const response = await fetch(API_BASE_URL + `/api/new/question/ValuePropositionPack/ValueDeliveryProcess/${projectId}`);
       if (!response.ok) {

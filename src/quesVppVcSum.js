...
function QuestionBusIntro() {
 ...
 const questionSubType ="ValueCommunicationPlan";
 ...
 useEffect(() => {
   const fetchAnswers = async () => {
     ...
     if(summaryResponse.ok) {
       ...
       const response = await fetch(API_BASE_URL + `/api/new/question/ValuePropositionPack/ValueCommunicationPlan/${projectId}`);
       if (!response.ok) {
